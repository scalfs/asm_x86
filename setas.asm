...
;funções de desenho.
;   Para o projetos que pretendem usar este código, recomenda-se criar uma 
;função indicando a posição onde cada seta ficará e atribuir seu tipo e cor 
;quando essas funções forem chamadas. Assim pode-se apagar a seta anterior 
;e redesenhá-la com o tipo e cor desejada.
